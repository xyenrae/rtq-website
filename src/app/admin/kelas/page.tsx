...
import { useKelas } from "@/hooks/admin/kelas/useKelas";
    ...
    <div className="p-6 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      <div className="flex flex-col md:flex-row gap-4 justify-between mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-1">
            Total {filteredKelases.length} kelas ditemukan
          </p>
        </div>
      ...
      {filteredKelases.length > 0 ? (
                ...
                {["judul", "short_desc"].map((key) => (
                  ...
                  >
                    <div className="flex items-center gap-2">
                      {key === "judul" ? "Judul" : "Deskripsi Singkat"}
                      {sortConfig?.key === key &&
                    ...
                    <div className="flex justify-center gap-3">
                      <motion.button
                        ...
                        onClick={() => {
                          ...
                          setFormData(kelas);
                          setShowModal(true);
                          setImagePreview(kelas.image_url);
                        }}
                      >
                        <FiEdit size={18} />
                      </motion.button>
        ...
        <div className="text-center py-12">
          <p className="text-gray-500">Tidak ada data kelas ditemukan</p>
        </div>
      )}
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mt-6 gap-4">
        <div className="text-gray-600">
          ...
          {Math.min(currentPage * itemsPerPage, filteredKelases.length)} dari{" "}
          {filteredKelases.length}
        </div>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, full_desc: e.target.value })
                    }
                  />
                </div>
