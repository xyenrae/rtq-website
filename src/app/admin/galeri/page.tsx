...
import { useGallery } from "@/hooks/admin/galeri/useGaleri";
...
const GalleryTable = () => {
  ...
  // State untuk error validasi (jika diperlukan)
  const [validationError, setValidationError] = useState<string | null>(null);

  // Efek untuk menampilkan error validasi via toast
  useEffect(() => {
    if (validationError) {
  ...
  // Fungsi onSubmit yang memvalidasi data menggunakan Zod sebelum memanggil handleSubmit dari hook
    ...
    <div className="p-6 bg-white rounded-xl shadow-lg border border-gray-100">
      ...
      {filteredItems.length > 0 ? (
        <div className="overflow-x-auto rounded-lg border border-gray-200">
          <table className="w-full">
            <thead className="bg-gray-50">
              <tr>
                {["image", "category", "created_at"].map((key) => (
                  <th
                    key={key}
        ...
        <div className="text-center py-12">
          <p className="text-gray-500">Tidak ada data galeri ditemukan</p>
        </div>
      )}
            ...
            >
              <div className="p-6 border-b border-gray-200 flex justify-between items-center">
                <h3 className="text-xl font-semibold">
                  {editingItem ? "Edit Item Galeri" : "Tambah Item Baru"}
                </h3>
                <button
                  onClick={() => {
                    setShowModal(false);
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        value={formData.galeri_kategori_id}
                        onChange={(e) =>
                          setFormData({
                            ...formData,
                            galeri_kategori_id: e.target.value,
                          })
                        }
                      >
